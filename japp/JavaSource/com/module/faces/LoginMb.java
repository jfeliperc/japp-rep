...
//		} catch (NoSuchAlgorithmException e) {
	...
	public void montarMenu(){
		...
		Menu pessoas = new Menu("pessoa","Pessoas","Cadastro de pessoas/usu�rios");
		...
		Menu serv = new Menu("servico","Servi�os","Cadastro de servi�os");
		...
		Menu saidaProd = new Menu("saidaEst","Sa�da","Sa�da de produtos");
		...
		Menu cardapio = new Menu("cardapio","Card�pio","Cadastro de card�pio");
