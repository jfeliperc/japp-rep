...
-- tabela:nfentrada ser� a tabela mestre da nf.
...
-- tabela:itemnfentrada ser� a tebela detalhes dos itens.
...
-- tabela:parcelasnfe ser� a tabela detalhes das parcelas da nf.
...
-- tabela:cfop_nfentrada ser� a tabela detalhes das cfop�s contidas na nf.
